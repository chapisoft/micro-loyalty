...
public class RedisService {
   ...
   public boolean tryLock(String lockKey) {
      return this.tryLock(lockKey, DEFAULT_WAIT_TIME, DEFAULT_LEASE_TIME, DEFAULT_TIME_UNIT);
   }
   ...
   public <T> T doWithLock(String lockKey, Supplier<T> task) {
      return this.doWithLock(lockKey, DEFAULT_WAIT_TIME, DEFAULT_LEASE_TIME, DEFAULT_TIME_UNIT, task);
   }
   ...
   public void doWithLock(String lockKey, Runnable task) {
      this.doWithLock(lockKey, DEFAULT_WAIT_TIME, DEFAULT_LEASE_TIME, DEFAULT_TIME_UNIT, task);
   }
