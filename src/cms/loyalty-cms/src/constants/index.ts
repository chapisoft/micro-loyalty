...
const defaultApiUrl = origin ? `${origin}/cms` : 'https://cms.miotp.io.vn/cms';

export const envVariables = {
  MODE: window.__ENV__?.VITE_MODE ?? import.meta.env.VITE_MODE ?? 'production',
  API_URL: window.__ENV__?.VITE_API_URL || defaultApiUrl,
  API_AUTH_URL: window.__ENV__?.VITE_API_AUTH_URL || defaultApiUrl,
  CMS_URL: window.__ENV__?.VITE_API_URL || defaultApiUrl,
  ...
  IMAGE_URL: window.__ENV__?.VITE_IMAGE_URL || (origin ? `${origin}/` : 'https://cms.miotp.io.vn/'),
};
