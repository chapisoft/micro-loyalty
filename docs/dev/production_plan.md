...
<tr>
  ...
  <th style="width: 20%; text-align: left;">Tên tác vụ kỹ thuật</th>
  <th style="width: 12%; text-align: left;">Phân hệ / Dự án</th>
  <th style="width: 32%; text-align: left;">Mô tả kỹ thuật và Phạm vi thực hiện</th>
  <th style="width: 15%; text-align: center;">Nguồn gốc / Mức độ kế thừa</th>
  <th style="width: 20%; text-align: left;">Tiêu chí hoàn thành (DoD)</th>
</tr>
</thead>
<tbody>
<tr style="background-color: #f0f4f8;">
  <td colspan="6" align="left"><strong>GIAI ĐOẠN 1: HẠ TẦNG KẾ THỪA, CƠ SỞ DỮ LIỆU POSTGRESQL 15+ VÀ BẢO MẬT B2B</strong></td>
</tr>
<tr style="background-color: #f8fafc;">
  <td colspan="6" align="left"><em>Sprint 1: Đợt Nước Rút 1 (Tuần 1) — Tích hợp bộ khung kế thừa &amp; Cơ sở dữ liệu</em></td>
</tr>
<tr>
...
<tr style="background-color: #f8fafc;">
  <td colspan="6" align="left"><em>Sprint 2: Đợt Nước Rút 2 (Tuần 2) — Khóa phân tán, Redis Streams, Outbox &amp; Giao thức SSO</em></td>
</tr>
<tr>
...
<tr style="background-color: #f0f4f8;">
  <td colspan="6" align="left"><strong>GIAI ĐOẠN 2: PHÁT TRIỂN 7 PHÂN HỆ NGHIỆP VỤ BACKEND &amp; GIAO DIỆN CMS</strong></td>
</tr>
<tr style="background-color: #f8fafc;">
  <td colspan="6" align="left"><em>Sprint 3: Đợt Nước Rút 3 (Tuần 3) — Hội viên, Sổ cái điểm, Cột mốc &amp; Ví Phần Thưởng</em></td>
</tr>
<tr>
...
<tr style="background-color: #f8fafc;">
  <td colspan="6" align="left"><em>Sprint 4: Đợt Nước Rút 4 (Tuần 4) — Cổng Game, Vòng quay, Bù trừ tài chính &amp; Batch Jobs</em></td>
</tr>
<tr>
...
<tr style="background-color: #f0f4f8;">
  <td colspan="6" align="left"><strong>GIAI ĐOẠN 3: TÍCH HỢP API GATEWAY, ỨNG DỤNG DI ĐỘNG &amp; CẦU NỐI JSBRIDGE</strong></td>
</tr>
<tr style="background-color: #f8fafc;">
  <td colspan="6" align="left"><em>Sprint 5: Đợt Nước Rút 5 (Tuần 5) — Nâng cấp API Gateway &amp; Đồng bộ hai chiều</em></td>
</tr>
<tr>
...
<tr style="background-color: #f8fafc;">
  <td colspan="6" align="left"><em>Sprint 6: Đợt Nước Rút 6 (Tuần 6) — Nâng cấp Ứng dụng di động Natcash &amp; Điểm bán POS</em></td>
</tr>
<tr>
...
<tr style="background-color: #f0f4f8;">
  <td colspan="6" align="left"><strong>GIAI ĐOẠN 4: KIỂM THỬ TẢI, AN TOÀN THÔNG TIN, ĐÓNG GÓI CI/CD &amp; VẬN HÀNH</strong></td>
</tr>
<tr style="background-color: #f8fafc;">
  <td colspan="6" align="left"><em>Sprint 7: Đợt Nước Rút 7 (Tuần 7) — Kiểm thử tải lớn, An ninh &amp; Tinh chỉnh cơ sở dữ liệu</em></td>
</tr>
<tr>
...
<tr style="background-color: #f8fafc;">
  <td colspan="6" align="left"><em>Sprint 8: Đợt Nước Rút 8 (Tuần 8) — Đóng gói CI/CD, Triển khai Production &amp; Chạy Pilot</em></td>
</tr>
<tr>
